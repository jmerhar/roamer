...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Insets the scrolling content away from the system bars.
     *
     * The window is edge-to-edge, so without this the foot of the content sits underneath the
     * navigation bar. The toolbar's own inset is handled by the app bar; this covers the
     * bottom and, in landscape, the sides and any display cutout.
     */
    private fun applyWindowInsets() {
        val content = findViewById<View>(R.id.scroll_content)
